...
This an experimental library intended for my personal technical education/training only. I started Proxy-JS as an experimental endeavour to evaluate the utilizability of ES6-Proxies for Javascript data binding. __BUT__ it is __NOT__ safe, tested or final for production environment or any other purpose.
